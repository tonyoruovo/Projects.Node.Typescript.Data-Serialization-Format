...
/**
 * @summary Defines the constituents of the yaml pipeline.
 * @description The yaml pipeline constitutes tokenisers (lexers) for tokenising text and json data; a parser which translates the
