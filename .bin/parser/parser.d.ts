...
import { Transformer, TransformStream, TransformStreamDefaultController, CountQueuingStrategy, ByteLengthQueuingStrategy, QueuingStrategy } from "node:stream/web";
...
declare namespace parser {
     ...
     */
    function parseText<P>(text: string, tokenizer: (text: string) => () => Token, format: {
        data: () => any;
        append: (input: any, syntax: Syntax, params?: P) => void;
    }, syntax: Syntax, params?: P): any;
    type Unicode = "utf-1" | "utf1" | "utf-7" | "utf7" | "utf-8" | "utf8" | "utf-16" | "utf16" | "utf16le" | "utf-16le" | "utf-32" | "utf32" | "utf-32le" | "utf32le" | "utf-64" | "utf64" | "utf-128" | "utf128" | "utf-ebcdic" | "utfebcdic";
    type Encoding = Unicode | "ascii" | "scsu" | "bocu-1" | "bocu1" | "gb18030" | "binary";
    /**
     ...
     */
    interface Type extends util.Equalizer {
        /**
     ...
     * their respective super ids (as it were).
     */
    interface GType<T> extends Type {
        /**
     ...
     */
    interface GToken<T> extends Token {
        /**
    ...
    interface Command {
         ...
         * {@label Command.parse}
         */
        parse(alreadyParsed: exp.Expression, yetToBeParsed: Token, parser: Parser, lexer: Lexer, syntax: Syntax): exp.Expression;
    }
    /**
     ...
     */
    interface GCommand<GT extends Token, E extends exp.Expression, S extends Syntax, L extends Lexer, PR extends Parser> extends Command {
        /**
         * @inheritdoc
         * @override
         * Does the parsing as usual
         */
        parse(alreadyParsed: E, yetToBeParsed: GT, parser: PR, lexer: L, syntax: S): E;
        /**
         ...
         */
        parse<P>(alreadyParsed: E, yetToBeParsed: GT, parser: PR, lexer: L, syntax: S, params: P): E;
    }
    /**
     ...
     */
    interface GLexer<GT extends Token, S extends Syntax> extends Lexer {
        /**
     ...
     */
    interface MutableLexer<T extends Token, S extends Syntax, CHUNK = string> extends GLexer<T, S> {
        /**
     ...
     */
    interface GSyntax<TY extends Type, C extends Command> extends Syntax {
        /**@inheritdoc */
     ...
     */
    interface GParser<E extends exp.Expression, S extends Syntax, L extends Lexer> extends Parser {
        /**
     ...
     */
    class PrattParser<E extends exp.Expression, S extends GSyntax<Type, GCommand<GToken<TV>, E, S, GLexer<GToken<TV>, S>, PrattParser<E, S, TV>>>, TV = string> implements GParser<E, S, GLexer<GToken<TV>, S>> {
        #private;
        /**
         ...
         * the AST of the values parsed
         */
        parseWithPrecedence<P>(beginingPrecedence: number, l: GLexer<GToken<TV>, S>, s: S, params: P): E;
        /**
         ...
         */
        consume<P>(expected: GType<any>, l: GLexer<GToken<TV>, S>, s: S, params: P): GToken<TV>;
        /**
         ...
         */
        match<P>(expected: GType<any>, l: GLexer<GToken<TV>, S>, s: S, params: P): boolean;
        /**
         ...
         */
        protected readAndPeek<P>(distance: number, l: GLexer<GToken<TV>, S>, s: S, params: P): GToken<TV>;
    }
    /**
     ...
     */
    abstract class AbstractConverter<S extends Syntax, P = any> extends Transform {
        readonly syntax: S;
        params: P;
        /**
         ...
         */
        constructor(options: TransformOptions, syntax: S, params: P);
        /**
     ...
     */
    abstract class Converter<Tk extends Token, E extends exp.Expression, S extends GSyntax<Type, GCommand<GToken<TV>, E, S, ML, P>>, P extends PrattParser<E, S, TV>, PARAMS, ML extends MutableLexer<Tk, S, C>, C, TV = string> extends AbstractConverter<S, PARAMS> {
        readonly lexer: ML;
        readonly parser: P;
        constructor(options: TransformOptions, lexer: ML, parser: P, syntax: S, params: PARAMS);
    }
    /**
     ...
     */
    abstract class AbstractTransformer<I = any, O extends exp.Expression = exp.Expression> implements Transformer<I, O> {
        /**
         ...
         */
        abstract start(controller: TransformStreamDefaultController<O>): void | PromiseLike<void>;
        /**
         ...
         */
        abstract transform(chunk: I, controller: TransformStreamDefaultController<O>): void | PromiseLike<void>;
        /**
         ...
         * @returns {void | PromiseLike<void>} A promise fulfilled with undefined.
         */
        abstract flush(controller: TransformStreamDefaultController<O>): void | PromiseLike<void>;
    }
    ...
    class BasicTransformer<I, O extends exp.Expression> extends TransformStream<I, O> {
        constructor(transformer: AbstractTransformer<I, O>, readableStrategy: QueuingStrategy<O>, writableStrategy?: QueuingStrategy<I>);
    }
    /**
     ...
     * @template E
     */
    interface GEvaluator<E> extends Evaluator {
        /**
