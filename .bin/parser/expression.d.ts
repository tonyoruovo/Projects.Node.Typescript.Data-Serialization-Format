...
declare namespace expression {
     ...
     * interface
     */
    class ExpressionError extends TypeError implements util.Equalizer {
        /**
     ...
     */
    interface Expression extends util.Comparable<Expression>, util.Equalizer, util.Hashable {
        /**
     ...
     */
    interface GExpression<F extends Format> extends Expression {
        /**
     ...
     * formatted by a user.
     */
    interface Format extends util.Equalizer, util.Hashable {
        /**
         ...
         * @returns {void}
         */
        append(data: string | number | bigint | boolean | object | (string | number | bigint | boolean | object | undefined | null)[] | undefined | null): void;
        /**
     ...
     */
    interface GFormat<T extends Expression, D> extends Format, util.Comparable<GFormat<T, D>> {
        /**
         * Parses the argument into a result and appends the result
         * to this object. This is a mutator.
     ...
     * an expression.
     */
    interface Evaluatable extends util.Equalizer {
        /**
     ...
     * of this class.
     */
    interface GEvaluatable<E extends Expression> extends Evaluatable {
        /**
